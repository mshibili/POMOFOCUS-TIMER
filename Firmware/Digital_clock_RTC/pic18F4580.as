...
TOSU equ 0FFFh ;# 
	...
	FNCALL	_init_config,_timer0_config
	FNROOT	_main
...
;main.c: 26: init_config();
	...
	line	29
;main.c: 27: static unsigned char editMode = 0, feild = 2;;
;main.c: 28: static unsigned char wait;
;main.c: 29: while(1)
	
l139:
	line	31
;main.c: 30: {
;main.c: 31: key = read_digital_keypad(0);
	movlw	(0)&0ffh
...
l1332:
;main.c: 37: {
;main.c: 38: if(editMode++ == 3)
	incf	((c:main@editMode)),c
		movlw	4
	xorwf	((c:main@editMode)),c,w
	btfss	status,2
	goto	u691
	goto	u690
...
l1334:
;main.c: 39: { editMode = 0;
	movlw	low(0)
	movwf	((c:main@editMode)),c
	line	40
...
l1336:
;main.c: 43: }
;main.c: 46: if(editMode == 1)
		decf	((c:main@editMode)),c,w
	btfss	status,2
	goto	u701
	goto	u700
...
l1340:
;main.c: 51: if(feild == 0)
	movf	((c:main@feild)),c,w
	btfss	status,2
	goto	u711
	goto	u710
u711:
...
l1342:
;main.c: 52: { if(minutes++ == 59) minutes = 0;
	incf	((c:_minutes)),c
		movlw	60
	xorwf	((c:_minutes)),c,w
	btfss	status,2
	goto	u721
	goto	u720
...
l1346:
;main.c: 55: else if(feild == 1)
		decf	((c:main@feild)),c,w
	btfss	status,2
	goto	u731
	goto	u730
...
l1352:
;main.c: 58: else
;main.c: 59: { if(seconds++ == 59) seconds = 0;
	incf	((c:_seconds)),c
		movlw	60
	xorwf	((c:_seconds)),c,w
	btfss	status,2
	goto	u751
	goto	u750
...
l1358:
;main.c: 65: { if(minutes-- == 0) minutes = 59;
	decf	((c:_minutes)),c
		incf	((c:_minutes)),c,w
	btfss	status,2
	goto	u771
...
l1362:
;main.c: 68: else if(feild == 1 && editMode)
		decf	((c:main@feild)),c,w
	btfss	status,2
	goto	u781
	goto	u780
...
l1370:
;main.c: 71: else
;main.c: 72: { if(seconds-- == 0) seconds = 59;
	decf	((c:_seconds)),c
		incf	((c:_seconds)),c,w
	btfss	status,2
	goto	u811
...
l1374:
;main.c: 77: if(feild++ == 2)
	incf	((c:main@feild)),c
		movlw	3
	xorwf	((c:main@feild)),c,w
	btfss	status,2
	goto	u821
	goto	u820
...
; Number of cases is 3, Range of values is 11 to 14
...
l1382:
;main.c: 112: }
;main.c: 114: if(editMode == 1 && dotMode)
		decf	((c:main@editMode)),c,w
	btfss	status,2
	goto	u831
	goto	u830
...
l1388:
;main.c: 118: { clock[3] = 0x00;
	movlw	low(0)
	movwf	(0+((c:_clock)+03h)),c
	line	119
;main.c: 119: clock[2] = 0x00;
	movlw	low(0)
...
l1392:
;main.c: 122: { clock[1] = 0x00;
	movlw	low(0)
	movwf	(0+((c:_clock)+01h)),c
	line	123
;main.c: 123: clock[0] = 0x00;
	movlw	low(0)
	movwf	((c:_clock)),c
	goto	l1402
	line	124
...
;main.c: 131: else
;main.c: 132: {
;main.c: 133: clock[3] = ssd_digit[ minutes % 10];
	movff	(c:_minutes),(c:___awmod@dividend)
	...
	movwf	(0+((c:_clock)+03h)),c
	line	134
;main.c: 134: clock[2] = ssd_digit[ minutes / 10];
	movff	(c:_minutes),(c:___awdiv@dividend)
...
l1396:
;main.c: 136: if(dotMode == 1) clock[1] = ssd_digit[ hours % 10] | 0x10;
		decf	((c:_dotMode)),c,w
	btfss	status,2
	goto	u871
	goto	u870
...
l1398:
	movff	(c:_hours),(c:___awmod@dividend)
	clrf	((c:___awmod@dividend+1)),c
	movlw	high(0Ah)
	movwf	((c:___awmod@divisor+1)),c
	movlw	low(0Ah)
...
l1400:
;main.c: 137: else clock[1] = ssd_digit[ hours % 10];
	movff	(c:_hours),(c:___awmod@dividend)
	clrf	((c:___awmod@dividend+1)),c
	movlw	high(0Ah)
	movwf	((c:___awmod@divisor+1)),c
...
l171:
	line	139
;main.c: 139: clock[0] = ssd_digit[ hours / 10];
	movff	(c:_hours),(c:___awdiv@dividend)
	clrf	((c:___awdiv@dividend+1)),c
	movlw	high(0Ah)
	movwf	((c:___awdiv@divisor+1)),c
	movlw	low(0Ah)
...
l950:
;main.c: 18: init_ssd_control();
	call	_init_ssd_control	;wreg free
	line	19
	
l952:
;main.c: 19: timer0_config();
	call	_timer0_config	;wreg free
	line	20
	
l954:
;main.c: 20: INTCONbits.GIE = 1;
...
;; *************** function _timer0_config *****************
;; Defined at:
;;		line 4 in file "timer0_config.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
psect	text3
	file	"timer0_config.c"
	line	4
	global	__size_of_timer0_config
	__size_of_timer0_config	equ	__end_of_timer0_config-_timer0_config
...
l896:
;timer0_config.c: 18: T0CS = 0;
	bcf	c:(32429/8),(32429)&7	;volatile
	line	21
	
l898:
;timer0_config.c: 21: TMR0IF = 0;
	bcf	c:(32658/8),(32658)&7	;volatile
	line	23
	
l900:
;timer0_config.c: 23: PSA = 0;
	bcf	c:(32427/8),(32427)&7	;volatile
	line	24
	
l902:
;timer0_config.c: 24: T0PS2 = 0;
	bcf	c:(32426/8),(32426)&7	;volatile
	line	25
	
l904:
;timer0_config.c: 25: T0PS1 = 1;
	bsf	c:(32425/8),(32425)&7	;volatile
	line	26
	
l906:
;timer0_config.c: 26: T0PS0 = 1;
	bsf	c:(32424/8),(32424)&7	;volatile
	line	33
	
l908:
;timer0_config.c: 33: TMR0IE = 1;
	bsf	c:(32661/8),(32661)&7	;volatile
	line	36
	
l910:
;timer0_config.c: 36: TMR0ON = 1;
	bsf	c:(32431/8),(32431)&7	;volatile
	line	39
	
l912:
;timer0_config.c: 39: PEIE = 1;
...
l31:
	return	;funcret
	opt stack 0
GLOBAL	__end_of_timer0_config
	__end_of_timer0_config:
	signat	_timer0_config,89
	global	_init_ssd_control

;; *************** function _init_ssd_control *****************
;; Defined at:
;;		line 6 in file "ssd_display.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l920:
;ssd_display.c: 9: TRISD = 0x00;
	movlw	low(0)
	movwf	((c:3989)),c	;volatile
	line	11
	
l922:
;ssd_display.c: 11: TRISA = TRISA & 0xF0;
...
l924:
;ssd_display.c: 14: PORTA = PORTA & 0xF0;
...
l1226:
;ssd_display.c: 20: unsigned int wait;
;ssd_display.c: 21: unsigned char data_bit;
;ssd_display.c: 22: unsigned char digit;
;ssd_display.c: 24: for (digit = 0; digit < 4; digit++)
	movlw	low(0)
...
l1232:
;ssd_display.c: 25: {
;ssd_display.c: 26: PORTD = data[digit];
...
i2l1204:
;timer0_ISR.c: 8: static unsigned long int count, count2;
;timer0_ISR.c: 10: if (TMR0IF)
...
;timer0_ISR.c: 13: TMR0 = TMR0 + 8;
	...
	line	15
;timer0_ISR.c: 15: if (++count2 == 625)
	movlw	low(01h)
	addwf	((c:isr@count2)),c
	movlw	0
	addwfc	((c:isr@count2+1)),c
	addwfc	((c:isr@count2+2)),c
	addwfc	((c:isr@count2+3)),c
		movlw	113
	xorwf	((c:isr@count2)),c,w
	bnz	i2u45_41
	movlw	2
	xorwf	((c:isr@count2+1)),c,w
iorwf	((c:isr@count2+2)),c,w
iorwf	((c:isr@count2+3)),c,w
	btfss	status,2
	goto	i2u45_41
	goto	i2u45_40
...
i2l1208:
;timer0_ISR.c: 16: {
;timer0_ISR.c: 17: count2 = 0;
	movlw	low(0)
	movwf	((c:isr@count2)),c
	movlw	high(0)
	movwf	((c:isr@count2+1)),c
	movlw	low highword(0)
	movwf	((c:isr@count2+2)),c
	movlw	high highword(0)
	movwf	((c:isr@count2+3)),c
	line	18
;timer0_ISR.c: 18: dotMode = !dotMode;
	movf	((c:_dotMode)),c,w
	btfsc	status,2
	goto	i2u46_41
	goto	i2u46_40
...
i2l1210:
;timer0_ISR.c: 19: }
;timer0_ISR.c: 21: if (++count == 75000)
	movlw	low(01h)
	addwf	((c:isr@count)),c
	movlw	0
	addwfc	((c:isr@count+1)),c
	addwfc	((c:isr@count+2)),c
	addwfc	((c:isr@count+3)),c
		movlw	248
	...
	bnz	i2u48_41
	decf	((c:isr@count+2)),c,w
iorwf	((c:isr@count+3)),c,w
	btfss	status,2
	goto	i2u48_41
	goto	i2u48_40
...
i2l1212:
;timer0_ISR.c: 22: {
;timer0_ISR.c: 23: count = 0;
	movlw	low(0)
	movwf	((c:isr@count)),c
	movlw	high(0)
	movwf	((c:isr@count+1)),c
	movlw	low highword(0)
	movwf	((c:isr@count+2)),c
	movlw	high highword(0)
	movwf	((c:isr@count+3)),c
	line	24
	
i2l1214:
;timer0_ISR.c: 24: if (minutes < 59)
		movlw	03Bh-0
	cpfslt	((c:_minutes)),c
	goto	i2u49_41
	goto	i2u49_40
...
i2l1218:
;timer0_ISR.c: 27: else
;timer0_ISR.c: 28: {
;timer0_ISR.c: 29: if (hours < 24)
		movlw	018h-0
	cpfslt	((c:_hours)),c
	goto	i2u50_41
	goto	i2u50_40
...
i2l1222:
;timer0_ISR.c: 31: else
;timer0_ISR.c: 32: hours = 12;
	movlw	low(0Ch)
	movwf	((c:_hours)),c
	
i2l248:
	line	33
;timer0_ISR.c: 33: minutes = 0;
	movlw	low(0)
	movwf	((c:_minutes)),c
	goto	i2l1224
	line	35
